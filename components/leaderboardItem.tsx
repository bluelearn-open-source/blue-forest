...
function LeaderBoardItem({level,avatar,discord_tag,coins}:thisProps) {
    ...
    return (
        <div className="inline-flex space-x-5 items-center justify-center" style={{ width: 440, height: 80, }}>
            <div className="relative" style={{ width: 160, height: 80, }}>
                ...
                <p className="w-9 absolute text-5xl font-black tracking-widest text-blue-600" style={{ left: 106, top: 10, }}>{}</p>
            </div>
            <p className="flex-1 text-2xl tracking-wider text-right text-gray-600">{discord_tag.split("#")[1]}<br />{coins} Coins</p>
        </div>
    )
}
